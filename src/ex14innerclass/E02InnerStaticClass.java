...
/*
 ...
 ※원래 클래스명앞에는 static을 붙일 수 없으나 내부클래스에는 허용된다.
 */
class OuterClass{
		//인스턴스형 멤버변수
		...
		void outerMemberMethod() {
			/*
			 ...
			 접근할 수 있다. (Heap영역에서는 Method영역을 참조할 수 있다.)
			 */
...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		 내부 정적 클래스의 정적멤버에 접근할 때는 외부클래스의 객체 생성없이
		 클래스명으로 바로 접근이 가능하다.
		 */
		...
		/*
		 ...
		 외부클래스의 멤버변수(메소드)는 객체 생성 후 참조변수를 통해
		 접근한다.
		 */
